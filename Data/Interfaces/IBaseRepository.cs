...
namespace DataLibrary.Interfaces
{
    public interface IBaseRepository<TEntity, TModel> where TEntity : class
    {
        ...
        Task<RepositoryResult<IEnumerable<TEntity>>> GetAllEntitiesAsync(bool orderByDescendning = false, Expression<Func<TEntity, object>>? sortBy = null, Expression<Func<TEntity, bool>>? where = null, params Expression<Func<TEntity, object>>[] includes);
    }
}